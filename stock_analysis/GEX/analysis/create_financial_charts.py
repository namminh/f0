...
def create_financial_charts():
    ...
    # Create directories
    Path("stock_analysis/GEX/charts/financial_analysis").mkdir(parents=True, exist_ok=True)
...
def create_profitability_analysis(income_data, ratios_data):
    ...
    ax1.set_title('GEX - Return on Equity (ROE)', fontweight='bold')
    ax1.set_ylabel('ROE (%)')
    ...
    ax2.set_title('GEX - Return on Assets (ROA)', fontweight='bold')
    ax2.set_ylabel('ROA (%)')
    ...
    ax3.set_title('GEX - Net Profit Margin', fontweight='bold')
    ...
    ax4.set_title('GEX - Profitability Comparison', fontweight='bold')
    ax4.set_xticks(x)
    ...
    plt.tight_layout()
    plt.savefig("stock_analysis/GEX/charts/financial_analysis/profitability_analysis.png", dpi=300, bbox_inches='tight')
    plt.close()
...
def create_financial_health_dashboard(balance_sheet_data, ratios_data):
    ...
    title_text = """
GEX - DIC CORPORATION FINANCIAL HEALTH DASHBOARD
═══════════════════════════════════════════════════════════════════════════════════════
...
✓ Strong project pipeline
    ...
    plt.tight_layout()
    plt.savefig("stock_analysis/GEX/charts/financial_analysis/financial_health_dashboard.png", dpi=300, bbox_inches='tight')
    plt.close()
...
def create_construction_specific_metrics(balance_sheet_data, income_data):
    ...
    ax1.set_title('GEX - Revenue by Segment', fontweight='bold')
    ...
    ax2.set_title('GEX - Project Completion Performance', fontweight='bold')
    ax2.grid(True, alpha=0.3)
    ...
    ax3.set_title('GEX - Contract Backlog & Working Capital', fontweight='bold')
    ax3.grid(True, alpha=0.3)
    ...
    ax4.set_title('GEX - Financial Leverage', fontweight='bold')
    ax4.grid(True, alpha=0.3)
    
    plt.tight_layout()
    plt.savefig("stock_analysis/GEX/charts/financial_analysis/real_estate_specific_metrics.png", dpi=300, bbox_inches='tight')
    plt.close()
...
def create_peer_comparison_template(ratios_data):
    ...
    plt.tight_layout()
    plt.savefig("stock_analysis/GEX/charts/financial_analysis/peer_comparison.png", dpi=300, bbox_inches='tight')
    plt.close()
...
def create_financial_trends_analysis(income_data, balance_sheet_data, ratios_data):
    ...
    ax1.set_title('GEX - Revenue & Profit Trends', fontweight='bold')
    ...
    ax2.set_title('GEX - Asset Growth', fontweight='bold')
    ...
    ax3.set_title('GEX - Efficiency Trends', fontweight='bold')
    ...
    ax4.set_title('GEX - Leverage & Liquidity Trends', fontweight='bold')
    ax4.grid(True, alpha=0.3)
    ...
    plt.tight_layout()
    plt.savefig("stock_analysis/GEX/charts/financial_analysis/financial_trends.png", dpi=300, bbox_inches='tight')
    plt.close()
