...
def analyze_shs_financial_data():
    """Phân tích dữ liệu tài chính SHS"""
    
    # Đọc dữ liệu
    with open('SHS_financial_data.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    print("=== PHAN TICH DU LIEU TAI CHINH CONG TY CO PHAN CHUNG KHOAN SAI GON - HA NOI (SHS) ===\n")
    
    # 1. Thong tin tong quan
    print("1. THONG TIN TONG QUAN:")
    overview = data['company_overview']['data']
    print(f"   - Ten cong ty: Cong ty Co phan Chung khoan Sai Gon - Ha Noi")
